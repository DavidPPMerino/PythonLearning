...
#     print(f'{moeda(n).replace(".", ",")}'.ljust(11))
#     print('Dobro do preço:'.ljust(29), end='')
#     print(f'{dobro(n, True).replace(".", ",")}'.ljust(11))
#     print('Metade do preço:'.ljust(29), end='')
#     print(f'{metade(n, True).replace(".", ",")}'.ljust(11))
#     print(f'{upperc}% de aumento:'.ljust(29), end='')
#     print(f'{aumentar(n, upperc, True).replace(".", ",")}'.ljust(11))
#     print(f'{downperc}% de redução:'.ljust(29), end='')
#     print(f'{diminuir(n, downperc, True).replace(".", ",")}'.ljust(11))
#     print('-' * 40)
